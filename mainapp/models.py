...
class News(models.Model):
    ...
    preambule = models.CharField(max_length=256, verbose_name='Preambule')
    body = models.TextField(blank=True, null=True, verbose_name='Body')
    body_as_markdown = models.BooleanField(default=False, verbose_name='AAs_markdown')
...
class CourseFeedback(models.Model):
    ...
    def __str__(self): return f"{self.course} ({self.user})"
...
class CourseTeachers(models.Model):
    ...
    day_birth = models.DateTimeField(default=timezone.now(), verbose_name='Birth day')
    deleted = models.BooleanField(default=False)
